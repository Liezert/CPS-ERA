...
class LearningMaterialResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Materi Learning';

    protected static ?string $modelLabel = 'Materi Learning';

    protected static ?string $pluralModelLabel = 'Materi Learning';

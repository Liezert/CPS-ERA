<div class="w-full sm:max-w-md">
    ...
    <div class="bg-white border border-neutral-200 rounded-lg p-6 sm:p-8">
        ...
        <div class="flex flex-col items-center text-center mb-6">
            <div class="w-16 h-16 rounded-xl bg-white border border-neutral-200/80 p-2 shadow-2xs flex items-center justify-center shrink-0 mb-3">
        ...
        <form wire:submit="authenticate" class="space-y-4">
            ...
            <div class="flex items-center">
                ...
                <label for="remember" class="ml-2 block font-sans text-xs text-neutral-600 select-none">

...
@switch($name)
    @case('home')
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 9.75L12 3l9 6.75M4.5 10.5v9.75a.75.75 0 00.75.75h4.5a.75.75 0 00.75-.75v-4.5a.75.75 0 01.75-.75h2.25a.75.75 0 01.75.75v4.5a.75.75 0 00.75.75h4.5a.75.75 0 00.75-.75V10.5" />
        </svg>
        @break
    ...
    @case('dokumen')
        {{-- Ikon outline netral Dokumen (Design System §5) --}}
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
    ...
    @case('video')
        {{-- Ikon outline netral Video (Design System §5) --}}
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
    ...
    @case('presentasi')
        {{-- Ikon outline netral Presentasi (Design System §5) --}}
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
    ...
    @case('lesson_learned')
        {{-- Ikon outline netral Lesson Learned (Design System §5) --}}
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
    ...
    @case('sop')
        {{-- Ikon outline netral SOP (Design System §5) --}}
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
    ...
    @case('link')
        {{-- Ikon outline netral Link Tautan (Design System §5) --}}
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
    ...
    @case('file_pendukung')
        {{-- Ikon outline netral File Pendukung --}}
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
            <path stroke-linecap="round" stroke-linejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3 3 0 1119.5 7.373L8.559 18.32a1.5 1.5 0 01-2.122-2.122l7.693-7.693" />
        </svg>
        @break

    @case('bookmark')
        {{-- Ikon outline Bookmark --}}
        <svg class="{{ $class }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">

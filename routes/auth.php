...
Route::middleware('guest')->group(function () {
    // Registrasi publik sengaja tidak ada: akun karyawan hanya dibuat admin (panel Filament / import CSV).
...
Route::middleware('auth')->group(function () {
    ...
    // Wajib ganti kata sandi sementara (akun buatan admin), lihat EnsurePasswordIsChanged.
